...
func _ready():
	...
	var sprout_scene = preload("res://snail_home.tscn")
	sprout_instance = sprout_scene.instantiate()
	add_child(sprout_instance)
	...
	snail_instance.set_home_window(sprout_instance.get_window())
